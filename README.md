...
**Latest release: [5.2.0](https://github.com/locationtech/geomesa/releases/tag/geomesa-5.2.0)** &nbsp;-&nbsp;
  [**Accumulo**](https://github.com/locationtech/geomesa/releases/download/geomesa-5.2.0/geomesa-accumulo_2.13-5.2.0-bin.tar.gz) |
  [**HBase**](https://github.com/locationtech/geomesa/releases/download/geomesa-5.2.0/geomesa-hbase_2.13-5.2.0-bin.tar.gz) |
  [**Cassandra**](https://github.com/locationtech/geomesa/releases/download/geomesa-5.2.0/geomesa-cassandra_2.13-5.2.0-bin.tar.gz) |
  [**Kafka**](https://github.com/locationtech/geomesa/releases/download/geomesa-5.2.0/geomesa-kafka_2.13-5.2.0-bin.tar.gz) |
  [**Redis**](https://github.com/locationtech/geomesa/releases/download/geomesa-5.2.0/geomesa-redis_2.13-5.2.0-bin.tar.gz) |
  [**FileSystem**](https://github.com/locationtech/geomesa/releases/download/geomesa-5.2.0/geomesa-fs_2.13-5.2.0-bin.tar.gz) |
  [**PostGIS**](https://github.com/locationtech/geomesa/releases/download/geomesa-5.2.0/geomesa-gt_2.13-5.2.0-bin.tar.gz)
...
```bash
gpg2 --verify geomesa-accumulo_2.13-5.2.0-bin.tar.gz.asc geomesa-accumulo_2.13-5.2.0-bin.tar.gz
```
